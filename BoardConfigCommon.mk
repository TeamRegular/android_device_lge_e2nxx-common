...
BOARD_KERNEL_CMDLINE := console=none user_debug=23 msm_rtb.filter=0x37 androidboot.hardware=e2 androidboot.bootdevice=msm_sdcc.1 androidboot.selinux=permissive
